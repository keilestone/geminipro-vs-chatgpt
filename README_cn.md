...
体验网址： [Gemini Pro Vs ChatGpt](https://www.geminiprovschatgpt.com)
...
> 3. 在你的 **Gemini Pro Vs Chatgpt** 项目中，设置名为 `API_BASE_URL` 的环境变量，其值为部署 palm-proxy 时获得的域名 (`https://xxx.vercel.app`)。
> 4. 重新部署你的 **Gemini Pro Vs Chatgpt** 项目来完成配置。这应该可以解决问题。
>
...
- [GeminiProChat](https://github.com/babaohuang/GeminiProChat) - 功能
